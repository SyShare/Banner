package com.banner.IndicatorView;
...
public class CircleIndicatorView extends View implements ViewPager.OnPageChangeListener {
    ...
    private void getAttr(Context context, AttributeSet attrs) {
        ...
        mRadius = (int) typedArray.getDimensionPixelSize(R.styleable.CircleIndicatorView_indicatorRadius, BannerUtils.dpToPx(6));
        mStrokeWidth = (int) typedArray.getDimensionPixelSize(R.styleable.CircleIndicatorView_indicatorBorderWidth, BannerUtils.dpToPx(2));
        mSpace = typedArray.getDimensionPixelSize(R.styleable.CircleIndicatorView_indicatorSpace, BannerUtils.dpToPx(5));
        // color
    ...
    public void onPageSelected(int position) {
        mSelectPosition = BannerUtils.getRealPosition(position, mCount);
        invalidate();
    }
